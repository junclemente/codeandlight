...
websites = [

    {
        ...
        GS Communication, giving them their first web presence. The backend \
        is developed with Python, Flask, and Jinja2. The frontend is designed \
    ...
    },
    {
        ...
        wedding of my brother and his fiance. The site incorporates \
        Bootstrap, HTML5, CSS3, JavaScript, jQuery and KnockoutJS. It is a \
        single page application (SPA). To minimize the costs for the bride \
        and groom, the site is hosted on Github Pages using a custom domain \
    ...
    },
    {
        ...
        "desc": "I maintain and update this website based on the information \
        provided by the site designer. Through this WordPress powered \
        website, I gain hands-on experience working with the Genesis \
    ...
    },
    {
        ...
        improve client-facing features. I also review and update \
        JavaScript/jQuery to current standards, fix bugs and improve speed \
        and efficiency. I collaborate with other team members to maintain and \
        update the website that uses PHP and MySQL in the backend."
    },
    {
    ...
    },
    {
        ...
        "desc": "I developed the first iteration of this website. This \
        resulted in an increase of clients and it extended their client-based \
